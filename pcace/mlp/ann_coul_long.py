...
"""
class ANN_Coul_Long(torch.nn.Module):
    """
    ...
    def __init__(
        ...
        # keys - energy/force
        key_energy  = "energy_coul_long",
        key_forces  = "forces_coul_long",
        key_virials = "virials_coul_long",
        key_stress  = "stress_coul_long",
        key_forces_edge = "forces_edge_coul_long",
    ):
        # == init ==
        super().__init__()
