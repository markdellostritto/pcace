...
"""
class ANN_LDamp_Cut(torch.nn.Module):
    """
    ...
    def __init__(
        ...
        # keys - energy/force
        key_energy  = "energy_ldamp_cut",
        key_forces  = "forces_ldamp_cut",
        key_virials = "virials_ldamp_cut",
        key_stress  = "stress_ldamp_cut",
        key_forces_edge = "forces_edge_ldamp_cut",
    ):
        # == init ==
        super().__init__()
